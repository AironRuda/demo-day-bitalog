...
const Footer: React.FunctionComponent = () => {
  return (
    <footer aria-label='Site Footer' className='bg-white'>
      <div className='max-w-screen-xl px-4 pt-8 mx-auto space-y-8 sm:px-6 lg:space-y-16 lg:px-8'>
        ...
        <div className='mt-4 grid grid-cols-1 gap-8 pt-4 border-t border-gray-100 sm:grid-cols-2 lg:grid-cols-4 lg:pt-2'>
          <div>
